...
class SWMainViewController: UITabBarController {
    ...
    func addChildViewControllers() {
        let first = SWMainVCStruct.init(title: "SwiftGrammar", imgName: "", vc: SwiftGrammarViewController())
        let second = SWMainVCStruct.init(title: "AR", imgName: "", vc: SWARHomeViewController())
        let third = SWMainVCStruct.init(title: "CoreML", imgName: "", vc: SWCoreMLHomeViewController())
